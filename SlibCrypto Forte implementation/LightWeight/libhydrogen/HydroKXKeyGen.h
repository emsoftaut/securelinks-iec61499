...
#ifndef _HYDROKXKEYGEN_H_
#define _HYDROKXKEYGEN_H_
...
class FORTE_HydroKXKeyGen: public CFunctionBlock{
  DECLARE_FIRMWARE_FB(FORTE_HydroKXKeyGen)
...
public:
  FUNCTION_BLOCK_CTOR(FORTE_HydroKXKeyGen){
  };

  virtual ~FORTE_HydroKXKeyGen(){};
