...
#ifndef _HYDROENCRYPT_H_
#define _HYDROENCRYPT_H_
...
class FORTE_HydroEncrypt: public CFunctionBlock{
  DECLARE_FIRMWARE_FB(FORTE_HydroEncrypt)
...
public:
  FUNCTION_BLOCK_CTOR(FORTE_HydroEncrypt){
  };

  virtual ~FORTE_HydroEncrypt(){};
