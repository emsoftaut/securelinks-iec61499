...
#ifndef _HYDROSECRETBOXPROBECREATE_H_
#define _HYDROSECRETBOXPROBECREATE_H_
...
class FORTE_HydroSecretBoxProbeCreate: public CFunctionBlock{
  DECLARE_FIRMWARE_FB(FORTE_HydroSecretBoxProbeCreate)
...
public:
  FUNCTION_BLOCK_CTOR(FORTE_HydroSecretBoxProbeCreate){
  };

  virtual ~FORTE_HydroSecretBoxProbeCreate(){};
